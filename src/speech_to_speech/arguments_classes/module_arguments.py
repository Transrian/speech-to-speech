...
class ModuleArguments:
    ...
    tts: Optional[Literal["chatTTS", "facebookMMS", "pocket", "kokoro", "qwen3", "kyutai-tts"]] = field(
        default="qwen3",
        metadata={
            "help": "The TTS to use. Either 'chatTTS', 'facebookMMS', 'pocket', 'kokoro', 'qwen3', or 'kyutai-tts'. "
            "Default is 'qwen3'."
        },
    )
    log_level: str = field(
